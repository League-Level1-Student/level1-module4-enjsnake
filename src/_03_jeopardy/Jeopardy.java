...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel headerPanel;
		headerPanel=createHeader("Video games");
	...
	public void actionPerformed(ActionEvent e) {
		...
		// If the buttonPressed was the firstButton
			...
			askQuestion("What game do I like the most?", "Apex Legends", 200);
			}
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("In Apex Legends, which legend do I like the most?","Wattson",400);
			}
